...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_saldo_on_kaksi_ja_puoli_euroa(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_saldo_on_nelja_euroa(self):
